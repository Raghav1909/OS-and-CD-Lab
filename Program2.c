// Given the list of processes and their CPU burst time, write a program to compute and print average waiting time and average turnaround time using SJF scheduling algorithm.
...
void main()
{
    int i, j, n, total_wait_time = 0, total_turnaround_time = 0, average_wait_time, average_turnaround_time;
